...
-- Function tạo layout 2 bên cho tab
local function CreateTwoSideLayout(parent)
    ...
    leftFrame.Size = UDim2.new(0.5, -1, 1, 0)
    leftFrame.Position = UDim2.new(0, 0, 0, 0)
    leftFrame.BackgroundTransparency = 1
    leftFrame.Parent = container

    local rightFrame = Instance.new("Frame")
    rightFrame.Size = UDim2.new(0.5, -1, 1, 0)
    rightFrame.Position = UDim2.new(0.5, 1, 0, 0)
    rightFrame.BackgroundTransparency = 1
    rightFrame.Parent = container
...
-- Function thêm tiêu đề ESP và FRUIT
local function AddTitlesToShopMicsTab(shopTabFrame)
    local leftFrame, rightFrame = CreateTwoSideLayout(shopTabFrame)
    ...
    espTitle.Parent = leftFrame

    local fruitTitle = Instance.new("TextLabel")
    fruitTitle.Size = UDim2.new(1, 0, 0, 20)
    fruitTitle.Position = UDim2.new(0, 0, 0, 0)
    fruitTitle.BackgroundTransparency = 1
    fruitTitle.Text = "FRUIT"
    fruitTitle.Font = Enum.Font.GothamBold
    fruitTitle.TextSize = 14
    fruitTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
    fruitTitle.TextXAlignment = Enum.TextXAlignment.Center
    fruitTitle.Parent = rightFrame

    return leftFrame, rightFrame
end

-- Function gắn sound vào toggle
local function AddClickSoundToToggle(toggleButton)
