...
local hopTitle = new("TextLabel", {Parent = leftFrame, Size = UDim2.new(1,0,0,18), BackgroundTransparency = 1, Text = "HOP", Font = Enum.Font.GothamBold, TextSize = 14, TextColor3 = TEXT_COLOR, TextXAlignment = Enum.TextXAlignment.Center})
new("Frame", {Parent = leftFrame, Size = UDim2.new(1,0,0,6), BackgroundTransparency = 1})
...
local function createActionButton(parent, text, onClick)
    local btn = new("TextButton", {Parent = parent, Size = UDim2.new(1, -12, 0, 36), BackgroundColor3 = TAB_COLOR, BorderSizePixel = 0, Text = text, Font = Enum.Font.Gotham, TextSize = 14, TextColor3 = TEXT_COLOR})
    new("UICorner", {Parent = btn, CornerRadius = UDim.new(0,6)})
    new("UIStroke", {Parent = btn, Color = BLUE, Thickness = 1})
...
createActionButton(leftFrame, "Hop Server", hopToAnyServer)
createActionButton(leftFrame, "Hop Server Low Player", hopToLowestServer)
createActionButton(leftFrame, "Rejoin Server", rejoinCurrent)
